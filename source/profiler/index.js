 ...
 * @function profiler
 * @description set an endcoding profile based on the sorurce height (defiend in the
 * mediaInfo metadata). define the height/width for framecapture. define the encoding
