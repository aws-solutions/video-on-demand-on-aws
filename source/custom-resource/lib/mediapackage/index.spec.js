...
describe('#MEDIAPACKAGE-VOD::', () => {
    ...
    describe('Create', () => {
        it('should succeed with valid parameters', async () => {
            AWS.mock('MediaPackageVod', 'createPackagingGroup', Promise.resolve());
    ...
    describe('Delete', () => {
        it('should succeed when group exists', async () => {
            AWS.mock('MediaPackageVod', 'listAssets', Promise.resolve(assetsResponse));
            AWS.mock('MediaPackageVod', 'listPackagingConfigurations', Promise.resolve(configurationsResponse));
