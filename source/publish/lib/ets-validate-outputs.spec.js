...
let lambda = require('../ets-validate-outputs.js');
...
describe('lambda', function() {
  ...
  describe('#ETS validate-outputs ETS ', function() {

    beforeEach(function() {
      process.env.AWS_LAMBDA_FUNCTION_NAME = 'testlambda';
      process.env.Mp4Destination = 'bucket';
    ...
    afterEach(function() {
      ...
      delete process.env.Mp4Destination;
